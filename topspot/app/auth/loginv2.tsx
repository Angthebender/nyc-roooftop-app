...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      router.replace('/') // go to main layout after login
    } catch (error: any) {
  ...
  return (
    ...
    <Stack.Screen options={{ headerShown: false }} />
        ...
        <View style={{marginBottom:10 }}>
            <Text style={{ fontSize:24, fontWeight:'bold', marginBottom:20, color:textColor }}>Login</Text>
      ...
      <TouchableOpacity onPress={handleLogin} style={{ backgroundColor:primaryColor, padding:15, borderRadius:10, alignItems:'center' }}>
      ...
      <Text style={{ marginTop:20, textAlign:'center', color:textColor }}>
        ...
        <Text style={{ color:primaryColor }} onPress={() => router.push('/auth/signup')}>Sign up</Text>
      </Text>
    </View>
  )
}
